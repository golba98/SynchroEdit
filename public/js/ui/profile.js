...
export class Profile {
    ...
    updateUI() {
        ...
        if (this.user.profilePicture) {
            ...
            iconElements.forEach(el => { if (el) el.style.display = 'none'; });
        } else {
            pfpElements.forEach(el => { if (el) el.style.display = 'none'; });
            iconElements.forEach(el => { if (el) el.style.display = 'flex'; });
        }
    }
