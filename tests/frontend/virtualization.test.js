 ...
 */
import { Editor } from '../../public/js/editor/editor.js';
...
jest.mock('../../public/js/managers/PageManager.js');
jest.mock('../../public/js/managers/BorderManager.js');
jest.mock('../../public/js/managers/CursorManager.js');
jest.mock('../../public/js/managers/ImageManager.js');
jest.mock('../../public/js/ui/ToolbarController.js');
jest.mock('../../public/js/managers/ReadabilityManager.js');
jest.mock('../../public/js/managers/NavigationManager.js');
jest.mock('../../public/js/ui/auth.js', () => ({
