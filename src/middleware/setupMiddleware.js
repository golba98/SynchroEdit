    ...
    app.use(helmet({
        contentSecurityPolicy: {
            directives: {
                ...
                styleSrc: ["'self'", "'unsafe-inline'", "cdnjs.cloudflare.com", "cdn.quilljs.com", "fonts.googleapis.com", "cdn.jsdelivr.net"],
                fontSrc: ["'self'", "cdnjs.cloudflare.com", "fonts.gstatic.com", "cdn.jsdelivr.net", "data:"],
