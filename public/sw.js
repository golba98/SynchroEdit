const CACHE_NAME = 'syncroedit-v10';
const ASSETS_TO_CACHE = [
  ...
  '/scripts/dom.js',
  '/scripts/state.js',
  '/scripts/auth/forgotPassword.js',
  '/scripts/auth/login.js',
  '/scripts/auth/resetPassword.js',
  '/scripts/auth/session.js',
  '/scripts/auth/signup.js',
  '/scripts/auth/start.js',
  '/scripts/auth/verify.js',
  '/scripts/editor/autosave.js',
  '/scripts/editor/document.js',
  '/scripts/editor/editor.js',
  '/scripts/editor/history.js',
  '/scripts/editor/pages.js',
  '/scripts/editor/presence.js',
  '/scripts/editor/websocket.js',
  '/scripts/ui/modals.js',
  '/scripts/ui/notifications.js',
